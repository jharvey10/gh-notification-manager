...
export function NotificationList({ notifications, selected, onToggle, onSelectRepo }) {
  ...
  const sorted = notifications.sort((a, b) => new Date(b.lastUpdatedAt) - new Date(a.lastUpdatedAt))
  ...
  return (
    <div className="join join-vertical w-full">
      <details
        key="newest"
        open
        className="join-item collapse collapse-arrow border border-base-300"
      >
